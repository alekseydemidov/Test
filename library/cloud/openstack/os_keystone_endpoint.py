...
# https://github.com/ansible/ansible/blob/devel/lib/ansible/modules/cloud/openstack/os_keystone_endpoint.py
# Documentation: https://docs.ansible.com/ansible/devel/os_keystone_endpoint_module.html
